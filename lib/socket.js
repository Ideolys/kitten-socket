...
const Socket = function (port, host, options) {
  ...
  /**
   * This function is called each time data is received. It buffers the data in _buffer and emit the 'message' event when the message is complete  
